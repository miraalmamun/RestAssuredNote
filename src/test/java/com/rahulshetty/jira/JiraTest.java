...
public class JiraTest {
	...
	public static void main(String[] args) {
		...
		/**
		 * How to create Session Filter for Authentication in Rest Assured Automation in 
		 * introducing Path Parameters and Query Parameters together inSingle Test sending 
		 * Files as attechment using Rest Assured with multipart method Parsing complex
		 * JSON and limiting JSON Response through query Parameters Handling HTTPS Certificate validation
		 * through Automate code
		 */
		
		
		/**
		 * Important Note: "SessionFilter session = new SessionFilter();","relaxedHTTPSValidation()"
		 * "filter(session)","multiPart("file", new File("jira.txt"))","header("Content-Type", "multipart/form-data")"
		 */
